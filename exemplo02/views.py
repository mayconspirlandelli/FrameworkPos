...
def ia_knn_treino(request):
    ...
    print(f'Tamanho do conjunto de treino: (_train.shape)')
    print(f'Tamanho do conjunto de teste: (X_test.shape)')
    print(f'Tamanho do conjunto de validação: (_val.shape)')
    ...
    # Definindo o grid de parâmetros para • KNN
    param_grid = {
        'n neighbors': [3, 5, 7, 9],  # Exemplos de valores possíveis
    ...
    grid_search = GridSearchCV(
        estimator=knn, param_grid=param_grid, cv=5, verbose=2, n_jobs=-1
    )
    ...
    model_filename = "knn model.pkl"  # Caminho do arquivo onde o modelo será salvo
